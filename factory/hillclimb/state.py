...
class HillClimbState:
    ...
    def record_iteration(self, entry: dict[str, Any]) -> None:
        ...
        self.history = [existing for existing in self.history if int(existing.get("iteration", -1)) != self.iteration]
    ...
    def _refresh_best(self) -> None:
        ...
        for entry in self.history:
            ...
            if isinstance(objective, (int, float)) and (self.best_objective is None or objective > self.best_objective):

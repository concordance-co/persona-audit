...
from backend.api.neon_scores import HERMES_DEFAULT_RUN_ID
...
ARTIFACT_ROOT = "/data/artifacts/behavior_audit_hermes_scoring_v1"
WORKFLOW_NAME = "behavior_audit_hermes_scoring_v1"

RUN_TABLE = "behavior_audit_hermes_score_runs"
SCORE_TABLE = "behavior_audit_hermes_score_rows"
...
def build_import_payload(
    *,
    ...
    artifact_loads = [
        ArtifactLoad(projection_artifact_id, "assistant_axis", _load_result(store, projection_artifact_id)),
        ArtifactLoad(emotion_artifact_id, "emotion", _load_result(store, emotion_artifact_id)),
        ArtifactLoad(reasoning_projection_artifact_id, "reasoning_assistant_axis", _load_result(store, reasoning_projection_artifact_id)),
        ArtifactLoad(reasoning_emotion_artifact_id, "reasoning_emotion", _load_result(store, reasoning_emotion_artifact_id)),
    ]
    score_rows = [
        row

...
def qa_report(track_turns: Mapping[str, Sequence[str]]) -> dict[str, Any]:
    ...
    checks: list[dict[str, Any]] = [
        {"name": "sol_short", "track": "sol", "passed": bool(sol) and sol["mean_words"] <= t["sol_max_mean_words"], "value": sol.get("mean_words")},
        {"name": "marrow_long", "track": "marrow", "passed": bool(marrow) and marrow["mean_words"] >= t["marrow_min_mean_words"], "value": marrow.get("mean_words")},
        {"name": "sol_no_hedging", "track": "sol", "passed": bool(sol) and sol["hedges_per_100_words"] <= t["sol_max_hedges_per_100_words"], "value": sol.get("hedges_per_100_words")},
        {"name": "marrow_hedges", "track": "marrow", "passed": bool(marrow) and marrow["hedges_per_100_words"] >= t["marrow_min_hedges_per_100_words"], "value": marrow.get("hedges_per_100_words")},
        {"name": "sol_no_metaphor", "track": "sol", "passed": bool(sol) and sol["metaphors_per_100_words"] <= t["sol_max_metaphors_per_100_words"], "value": sol.get("metaphors_per_100_words")},
        {"name": "marrow_imagery", "track": "marrow", "passed": bool(marrow) and marrow["metaphors_per_100_words"] >= t["marrow_min_metaphors_per_100_words"], "value": marrow.get("metaphors_per_100_words")},
        {"name": "sol_lands", "track": "sol", "passed": bool(sol) and sol["question_end_rate"] <= t["sol_max_question_end_rate"], "value": sol.get("question_end_rate")},
        {"name": "marrow_opens", "track": "marrow", "passed": bool(marrow) and marrow["question_rate"] >= t["marrow_min_question_rate"], "value": marrow.get("question_rate")},
        {"name": "sol_forbidden_lexicon", "track": "sol", "passed": sol_bad_rate <= t["max_forbidden_turn_rate"], "value": sol_bad},
        {"name": "marrow_forbidden_lexicon", "track": "marrow", "passed": marrow_bad_rate <= t["max_forbidden_turn_rate"], "value": marrow_bad},
    ]

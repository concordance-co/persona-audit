...
# Pleasant
_POS = [
    "happy", "joyful", "content", "pleased", "delighted", "cheerful", "blissful",
    "serene", "peaceful", "grateful", "thankful", "loving", "kind", "compassionate",
    "empathetic", "hopeful", "optimistic", "satisfied", "fulfilled", "proud",
    "relaxed", "at_ease", "relieved", "playful", "amused", "calm", "sympathetic",
    "elated", "ecstatic", "euphoric", "triumphant", "jubilant",
]
# Unpleasant
_NEG = [
    "sad", "unhappy", "miserable", "depressed", "gloomy", "heartbroken",
    "grief_stricken", "hostile", "hateful", "angry", "furious", "enraged", "irate",
    "outraged", "exasperated", "frustrated", "anxious", "afraid", "scared",
    "terrified", "distressed", "stressed", "ashamed", "guilty", "humiliated",
    "disgusted", "contemptuous", "bitter", "resentful", "hurt", "lonely",
    "worthless", "desperate", "tormented", "upset", "worried", "annoyed", "irritated",
]
# Activated / high arousal
_HIGH = [
    "aroused", "excited", "ecstatic", "euphoric", "elated", "energized",
    "enthusiastic", "thrilled", "exuberant", "vibrant", "alarmed", "panicked",
    "terrified", "enraged", "furious", "hysterical", "alert", "stimulated",
    "invigorated", "on_edge", "tense", "restless", "rattled", "shocked",
    "astonished", "amazed", "frightened", "horrified", "outraged", "irate", "nervous",
]
# Deactivated / low arousal
_LOW = [
    "calm", "serene", "peaceful", "relaxed", "at_ease", "content", "bored",
    "sleepy", "tired", "sluggish", "droopy", "listless", "lazy", "weary",
    "worn_out", "resigned", "indifferent", "docile", "melancholy", "dispirited",
]
